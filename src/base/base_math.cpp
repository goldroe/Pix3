...
internal f32 angle_from_vector(v2 v) {
...
internal v2 normalize_v2(v2 v) {
    ...
    result = (length == 0.f) ? V2() : div_v2_s(v, length);
    return result;
}
...
internal v3 normalize_v3(v3 v) {
    ...
    result = (length == 0.f) ? V3() : div_v3_s(v, length);
    return result;
}
...
internal v4 normalize_v4(v4 v) {
    ...
    result = (length == 0.f) ? V4() : div_v4_s(v, length);
    return result;
}
